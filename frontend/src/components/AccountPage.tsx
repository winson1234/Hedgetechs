           ...
           <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg shadow-sm">
             ...
             <div className="p-5 md:p-6 lg:p-8">
                <div className="flex justify-end mb-6">
                    <button onClick={() => handleOpenCreateModal(activeTab)} className={`inline-flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors shadow-sm ${activeTab === 'live'? 'bg-indigo-600 hover:bg-indigo-700 text-white': 'bg-green-600 hover:bg-green-700 text-white'}`}><PlusIcon /> Open New {activeTab === 'live' ? 'Live' : 'Demo'} Account</button>
                </div>
