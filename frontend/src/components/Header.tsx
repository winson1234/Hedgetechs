...
export default function Header() {
  ...
  return (
<header className="sticky top-0 z-50 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-2 sm:px-4 py-2">      <div className="flex items-center justify-between gap-2">
        {/* Left Side: Title */}
        ...
        <div className="flex items-center gap-1 sm:gap-2 lg:gap-4">
          ...
          <button
              ...
              className="text-white px-3 py-1.5 rounded text-xs md:text-sm font-medium transition-all flex items-center gap-2"
              style={{
          ...
          {/* Theme Toggle Button */}
          <button
            className="p-1.5 sm:p-2 border border-slate-300 dark:border-slate-700 rounded text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition"
