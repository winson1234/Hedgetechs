...
interface LiveAccountDetailModalProps {
  account: {
    id: string;
    account_id: number;
    type: 'live';
...
export default function LiveAccountDetailModal({
  account,
  isOpen,
  onClose,
}: LiveAccountDetailModalProps) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">
                  {formatAccountId(account.account_id, 'live')}
                </p>
              </div>
              <div>
                <p className="text-xs text-slate-600 dark:text-slate-400 mb-1">Account Type</p>
                <span className="inline-block text-xs font-bold text-indigo-700 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-900/50 px-2 py-1 rounded uppercase">
                  Live
                </span>
              </div>
