...
export function useScrollAnimations(options: ScrollAnimationOptions = {}) {
  ...
  useEffect(() => {
    ...
    const observeSectionText = () => {
      ...
      const standaloneTitles = document.querySelectorAll('.section-title:not(.animate-in)');
      const featureTitles = document.querySelectorAll('.features-main-title:not(.animate-in)');
      const payoutTitles = document.querySelectorAll('.payout-title:not(.animate-in)');
      ...
      const standaloneSubtitles = document.querySelectorAll('.section-subtitle:not(.animate-in)');
      const featureDescs = document.querySelectorAll('.features-main-desc:not(.animate-in)');
      const payoutDescs = document.querySelectorAll('.payout-desc:not(.animate-in)');
